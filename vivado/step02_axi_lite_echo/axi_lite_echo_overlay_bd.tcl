...
################################################################
# This is a generated script based on design: axi_lite_echo_overlay
#
...
# source axi_lite_echo_overlay_script.tcl
...
kr260intro.local:user:axi_lite_echo:1.0\
...
\
  ...
  # Create instance: axi_lite_echo_0, and set properties
  set axi_lite_echo_0 [ create_bd_cell -type ip -vlnv kr260intro.local:user:axi_lite_echo:1.0 axi_lite_echo_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins axi_lite_echo_0/S_AXI]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_lite_echo_0/S_AXI/reg0] -force
