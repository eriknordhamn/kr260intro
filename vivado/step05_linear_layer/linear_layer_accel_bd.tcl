...
################################################################
# This is a generated script based on design: linear_layer
#
...
# source linear_layer_script.tcl
...
kr260intro.local:user:linear_layer:1.0\
"
...
\
  ...
  # Create instance: linear_layer_0, and set properties
  set linear_layer_0 [ create_bd_cell -type ip -vlnv kr260intro.local:user:linear_layer:1.0 linear_layer_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins linear_layer_0/s_axis]
  ...
  connect_bd_intf_net -intf_net linear_layer_0_m_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins linear_layer_0/m_axis]
  ...
  [get_bd_pins linear_layer_0/aresetn]
  ...
  [get_bd_pins linear_layer_0/aclk]
